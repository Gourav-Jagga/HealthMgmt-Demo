package com.gjdev.auth.security.services;

import com.gjdev.auth.models.User; // Import User model
import com.gjdev.auth.repository.UserRepository; // Import UserRepository for user database operations
