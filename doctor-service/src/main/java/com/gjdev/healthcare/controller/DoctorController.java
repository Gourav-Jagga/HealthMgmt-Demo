...
import com.gjdev.healthcare.payload.response.GenericResponse;
import com.gjdev.healthcare.services.DoctorService;
...
public class DoctorController {
    ...
    public ResponseEntity<?> getDoctorById(@PathVariable String id) throws ResourceNotFoundException {
        try {
            com.gjdev.healthcare.model.Doctor doctor = doctorService.getDoctorById(id);
    ...
    public ResponseEntity<?> getDoctorByEmail(@PathVariable String email) throws ResourceNotFoundException {
        try {
            com.gjdev.healthcare.model.Doctor doctor = doctorService.getDoctorByEmail(email);
            return ResponseEntity.status(200).body(new GenericResponse<>("Doctor fetched successfully", doctor));
        } catch (Exception e) {
    ...
    public ResponseEntity<?> getAllDoctors() throws Exception {
        try {
            List<com.gjdev.healthcare.model.Doctor> doctors = doctorService.getAllDoctors();
    ...
    @PostMapping
    public ResponseEntity<?> saveDoctor(@Valid @RequestBody Doctor doctor) throws Exception {
        try {
            com.gjdev.healthcare.model.Doctor savedDoctor = doctorService.addDoctor(doctor);
    ...
    public ResponseEntity<?> updateDoctor(@Valid @RequestBody Doctor doctor, @PathVariable String id) throws Exception {
        try {
            com.gjdev.healthcare.model.Doctor updatedDoctor = doctorService.updateDoctorById(id, doctor);
