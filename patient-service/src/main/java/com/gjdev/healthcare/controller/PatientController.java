...
import com.gjdev.healthcare.services.PatientService;
...
public class PatientController {
    ...
    public ResponseEntity<?> getPatientById(@PathVariable String id) throws ResourceNotFoundException {
        try {
            com.gjdev.healthcare.model.Patient patient = patientService.getPatientById(id);
    ...
    public ResponseEntity<?> getPatientByEmail(@PathVariable String email) throws ResourceNotFoundException {
        try {
            com.gjdev.healthcare.model.Patient patient = patientService.getPatientByEmail(email);
    ...
    public ResponseEntity<?> getAllPatients() throws Exception {
        try {
            List<com.gjdev.healthcare.model.Patient> patients = patientService.getAllPatients();
    ...
    public ResponseEntity<?> savePatient(@Valid @RequestBody Patient patient) throws Exception {
        try {
            com.gjdev.healthcare.model.Patient savedPatient = patientService.addPatient(patient);
    ...
    public ResponseEntity<?> updatePatient(@Valid @RequestBody Patient patient, @PathVariable String id) throws Exception {
        try {
            com.gjdev.healthcare.model.Patient updatedPatient = patientService.updatePatientById(id, patient);
